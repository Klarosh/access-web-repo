...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      // Cleanup animations or ScrollTrigger if any
  ...
  return (
    <section
      id="HeroSection"
      className="min-h-dvh w-screen bg-blue-75 text-blue-50 overflow-x-hidden"
    >
      {loading && (
        <div className="flex flex-col items-center justify-center absolute z-[100] h-dvh w-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-white">
